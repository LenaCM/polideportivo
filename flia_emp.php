...
<body>
	...
	<div class="wrapper cf">
		...
		<header class="cf">
			...
			<nav class="cf">
				<ul id="nav" class="sf-menu">
					<!-- Nuevo menu para Familiares de empleados -->
					...
					<li class="current-menu-item"><a href="flia_emp.php"><span>FLIA EMPLEADOS</span></a></li>
		...
		<div role="main" id="main" class="cf">
			...
			<!-- headline -->
			<div class="headline">Panel Administracion de Familiares de Empleados</div>
			<!-- ENDS headline -->
			...
			<!-- Toggle opciones -->
				<div class="page-content entry-content feature cf">
					...
					<div class="toggle-trigger">
						...
						Dar de alta un Familiar de Empleado
						<img class="mas" src="img/bullets/plus.png">
						<img class="menos" src="img/bullets/minus.png">
					</div>		
				...
				<!-- ENDS form -->
					...
					<div class="toggle-trigger">
						<img class="mas" src="img/bullets/plus.png">
						<img class="menos" src="img/bullets/minus.png">
						Modificar datos de un Familiar de Empleado
						<img class="mas" src="img/bullets/plus.png">
						<img class="menos" src="img/bullets/minus.png">
					</div>				
					<div class="toggle-container">
					...
					<div class="toggle-trigger">
						<img class="mas" src="img/bullets/plus.png">
						<img class="menos" src="img/bullets/minus.png">
						Dar de baja a un Familiar de Empleado
						<img class="mas" src="img/bullets/plus.png">
						<img class="menos" src="img/bullets/minus.png">
					</div>				
					<div class="toggle-container">
					...
					<div class="toggle-trigger">
						<img class="mas" src="img/bullets/plus.png">
						<img class="menos" src="img/bullets/minus.png">
						Buscar un Familiar de Empleado
						<img class="mas" src="img/bullets/plus.png">
						<img class="menos" src="img/bullets/minus.png">
					</div>				
					<div class="toggle-container">
