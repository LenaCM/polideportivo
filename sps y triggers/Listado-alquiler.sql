...
for rec in select apellido, nombre, nombre_instalacion, fecha, hora, costo, numero_socio, pagado
...
for rec in select apellido, nombre, nombre_instalacion, fecha, hora, costo, 0, pagado
