...
--Alta
create or replace function sp_alta_no_socio(nombre_ text, apellido_ text, doc integer, tip_doc text)
	returns void as $$
declare
...
begin
	...
	if doc<0 then
		raise exception 'El campo documento no puede estar vacio';
	end if;
