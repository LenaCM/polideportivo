			...
			<?php
				...
				if (isset($_POST['num_doc']) && !empty($_POST['num_doc']) &&
					...
					if ($reg = pg_fetch_assoc($row)) {
						...
						echo "<tr><td>".$name."</td><td>".$ape."</td><td>".$num_doc."</td><td>".$tipo_doc."</td><td>".$num_soc."</td><td>".$fecha_alta."</td><td>".$estado."</td><td><a href=modificar.php?ID=".$num_soc.">MODIFICAR</a></td><td><a href=borrar_socio_resul.php?ID=".$num_soc."&tipo_busq=".$tipo_busq."&tipo_doc=".$tipo_doc.">ELIMINAR</a></td><td><a href=agregar_cuota.php?num_soc=".$num_soc."&tipo_busq=".$tipo_busq.">AGREGAR CUOTA</a></td></tr>";
					} else {
					...
					if ($reg = pg_fetch_array($row)) {
						...
						echo "<tr><td>".$name."</td><td>".$ape."</td><td>".$num_doc."</td><td>".$tipo_doc."</td><td>".$num_soc."</td><td>".$fecha_alta."</td><td>".$estado."</td><td><a href=modificar.php?ID=".$num_soc.">MODIFICAR</a></td><td><a href=borrar_socio_resul.php?ID=".$num_soc."&tipo_busq=".$tipo_busq.">ELIMINAR</a></td><td><a href=agregar_cuota.php?".$num_soc."&tipo_busq=".$tipo_busq.">AGREGAR CUOTA</a></td></tr>";
					} else {
						echo "<tr><td colspan=8>No es Socio</td></tr>";
					}
				} else {
